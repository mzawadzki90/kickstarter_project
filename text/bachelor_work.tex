...
\begin{document}
    ...
    \begin{itemize}
        ...
        \item $min_delta = 0.1$ - minimalna wartość poprawy metryki
    ...
    \begin{itemize}
        \item $hidden_1_units = 181$
        \item $hidden_1_dropout_rate = 0.10379824743424901$
        \item $hidden_2_units = 112$
        \item $hidden_2_dropout_rate = 0.09567409338419407$
        \item $hidden_3_units = 55$
        \item $hidden_3_dropout_rate = 0.01$
        \item $batch_size = 100$
    \end{itemize}
    ...
    \begin{itemize}
        \item $min_delta=0.01$
        \item $patience=10$
        \item $restore_best_weights=True$ - przywrócenie wartości wag dla połączeń z najlepszego przebiegu
    \end{itemize}
