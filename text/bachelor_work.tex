...
\begin{document}
    ...
    \begin{figure}[H]
        \label{tab:table_metrics_values_comparison}
        \centering
    ...
    \begin{figure}[H]
        \label{tab:table_real_predictions}
        \centering
    ...
    \begin{figure}[H]
        ...
        \caption{Wizualizacja zestawienia wartości rzeczywistych z predykcjami wykonana na podstawie tabeli \ref{tab:table_real_predictions}.}
    \end{figure}
    ...
    \noindent
    \begin{minipage}[H]{\textwidth}
        \setlength\parindent{17pt} Najlepsza i najgorsza predykcja: \\
        \bigskip
