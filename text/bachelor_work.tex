...
\begin{document}
    ...
    Najpopularniejszymi mediami muzycznymi w naszym kraju od lat, niezmiennie pozostają radio i telewizja - korzysta z nich odpowiednio 68\% i 39\% dorosłej populacji Polski\cite{cbos2018}. Z roku na rok umacnia się natomiast pozycja internetu. Nieodpłatnie muzyki za pośrednictwem tego medium deklarowało 30\% Polaków, odpłatnie 8\%\cite{cbos2018}. Trend wzrostowy będzie się z pewnością utrzymywał ze względu na poprawę dostępności szerokopasmowego internetu stacjonarnego i mobilnego, oraz nieustanie rosnącą popularność smartfonów i innych urządzeń mobilnych, które można podpiąć do globalnej sieci. Internet ma również tą niepodważalną przewagę nad innymi mediami, że udostępnia ogromną, staje zwiększającą się liczbę kanałów dystrybucji treści muzycznych. Najważniejsze z nich to Youtube, Vimeo, streaming-owe serwisy muzyczne (Spotify, Tidal, Apple Music, Amazon Music, Deezer), radia internetowe (także odpowiedniki tradycyjnych radiostacji), pliki do pobrania dostępne na serwerach, pliki torrent i inne.
