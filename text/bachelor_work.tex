...
\begin{document}
    ...
    Algorytm genetyczny może pomóc w doborze zbliżonych do optymalnych hiperparametrów procesu uczenia sieci neuronowej i tym samym przyczynić się znacząco do poprawy dokładności predykcji (o 5 do 10\%) finalnego modelu - licząc na podstawie metryki RMSE (ang. \textit{root mean squared error} pl. błąd średniokwadratowy) w porównaniu do sieci neuronowych inicjowanych wartościami sugerowanymi jako wyjściowe w literaturze przedmiotu lub dobranych intuicyjnie metodą `prób i błędów'.
    ...
    \begin{itemize}
        ...
        \item selekcja naturalna (ang. \textit{natural selection}) - Pojęcie wywodzące się z teorii ewolucji Charlesa Darvina i odgrywające w niej kluczową rolę; determinuje, które osobniki w populacji będą mieć szanse na reprodukcję; faworyzuje osobniki, które rywalizują o dostępne zasoby w sposób najbardziej efektywny\cite{IntroductionToEvolutionaryComputing2015}.
    ...
    \begin{itemize}
        ...
        \item dwie warstwy ukryte posiadające między 10 a 250 neuronów; wagi i obciążenia inicjowane funkcją He z rozkładem normalnym; normalizacja wsadowa ($momentum = 0.99$); aktywacja funkcją ELU; regularyzacja przez porzucenie (ang. \textit{Dropout}) ze współczynnikiem porzucania wynoszącym między 0.05 a 0.5
    ...
    Decyzja o zastosowaniu tylko dwóch warstw ukrytych podyktowana była specyfiką działania algorytmu genetycznego i wynikającą z niej koniecznością skrócenia średniego czasu uczenia pojedynczego modelu.
